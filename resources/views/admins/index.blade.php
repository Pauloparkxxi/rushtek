            ...
            <div class="m-2 flex flex-wrap justify-between items-center">
                ...
                <form class="flex flex-wrap justify-end items-center">
                    ...
                    <span class="flex-none items-center">
                        <input type="search" id="default-search" class="text-sm text-green-900 bg-gray-50 rounded-lg border border-green-400 focus:ring-green-500" placeholder="Search Staff" required>
                    ...
                    <div class="p-2">
                        <table class="table-fixed overflow-scroll w-full">
                            <thead class="text-left text-white bg-green-700">
                                <tr>
                                    <th class="p-2">Admin Name</th>
                                    <th class="p-2 hidden sm:table-cell">Email</th>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-green-100">
                                <td class="p-2 items-center flex">
                                    <img class="w-8 h-8 rounded-full" src="{{ $admin->avatar ? asset('asset/img/profile/'.$admin->avatar) : asset('asset/img/profile/default_profile.png') }}" alt="">
                                ...
                                <td class="p-2 hidden md:table-cell">
                                    <span class="font-medium">{{ $admin->status ? 'Active' : 'Inactive' }}</span>
                                </td>
                                <td class="p-2">
