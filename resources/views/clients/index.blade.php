            ...
            <div class="m-2 flex flex-wrap justify-between items-center">
                ...
                <form class="flex flex-wrap justify-end items-center">
                    ...
                    <span class="flex-none items-center">
                        <input type="search" id="default-search" class="text-sm text-green-900 bg-gray-50 rounded-lg border border-green-400 focus:ring-green-500" placeholder="Search Clients" required>
                        ...
                        <table class="table-fixed overflow-scroll w-full">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-green-100">
                                <td class="p-2 items-center flex">
                                    <img class="w-8 h-8 rounded-full" src="{{ $client->avatar ? asset('asset/img/profile/'.$client->avatar) : asset('asset/img/profile/default_profile.png') }}" alt="">
                                ...
                                <td class="p-2">
                                    <span class="flex flex-wrap items-center justify-center space-x-2">
                                        <a href="{{ route('clients') }}" class="btn bg-white my-1 hover:bg-green-700 hover:text-white rounded-lg px-3 border border-green-600">
                                            View
                                        </a>
                                        <a href="{{ route('clients') }}" class="btn bg-white my-1 hover:bg-red-700 hover:text-white hover:border-red-700 rounded-lg px-3 border border-green-600">
                                            Delete
                                        </a>
                                    </span>
                                </td>
