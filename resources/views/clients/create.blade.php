<x-app-layout>
    ...
    <div class="w-full lg:w-3/6 m-6">
        <span class="flex items-center space-x-4">
            <h1 class="text-5xl font-bold leading-tight">Add Client</h1>
            <a href="{{ route('clients') }}" class="btn bg-green-700 text-white font-bold rounded-full px-3 py-1 my-2 
        ...
        <div class="bg-white shadow-md p-5">
            ...
            <form method="POST" autocomplete="off" action="{{ route('clients.store') }}"  enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <input value="" type="text" name="address" id="idAddress" class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline"  required>
                </div>
