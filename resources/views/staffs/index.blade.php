    ...
    <div class="py-3">
        <div class="max-w-6xl mx-auto">
            <div class="m-2 flex flex-wrap justify-between items-center">
                ...
                <form method="GET" autocomplete="off" action={{ route('staffs') }} class="flex flex-wrap justify-end items-center">
                    ...
                    <span class="flex-none items-center">
                        <input type="search" value="{{ $search }}" name="search" id="idSearch" class="text-sm text-green-900 bg-gray-50 rounded-lg border border-green-400 focus:ring-green-500" placeholder="Search Staffs">
                        ...
                        <table class="table-fixed overflow-scroll w-full">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-green-100">
                                <td class="p-2 items-center flex">
                                    <img class="w-8 h-8 rounded-full object-cover" src="{{ $staff->avatar ? asset('asset/img/profile/'.$staff->avatar) : asset('asset/img/default_profile.png') }}" alt="">
                                ...
                                <td class="p-2">
                                    <span class="flex flex-wrap items-center justify-center space-x-2">
                                        ...
                                        <a href="{{ route('staffs.delete',$staff->user_id) }}" class="btn bg-white my-1 hover:bg-red-700 hover:text-white hover:border-red-700 rounded-lg px-3 border border-green-600" onclick="return confirm('Are you sure to delete?')">
                                            Delete
                                        </a>
                                    </span>
                                </td>
