            ...
            <div class="m-2 flex flex-wrap justify-between items-center">
                ...
                <form class="flex flex-wrap justify-end items-center">
                    ...
                    <span class="flex-none items-center">
                        <input type="search" id="default-search" class="text-sm text-green-900 bg-gray-50 rounded-lg border border-green-400 focus:ring-green-500" placeholder="Search Staffs" required>
